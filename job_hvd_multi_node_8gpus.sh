...
#SBATCH --output /gpfs/home/nct01/nct01035/Lab10_horovod/jobs/hvd_multinode_8gpus_%j.output
#SBATCH --error /gpfs/home/nct01/nct01035/Lab10_horovod/jobs/hvd_multinode_8gpus_%j.err

#SBATCH --ntasks-per-node=4     # must be added to create SLURM_NTASKS_PER_NODE var
#SBATCH -n 8                   # ntasks must be mutiple of ntasks-per-node. nnodes is ntasks/ntasks-per-node
...
python3.7 tf2_keras_cifar_hvd.py --epochs 8 --batch_size 512 --model_name='resnet'
